...
# pairing is in-matrix; the =2.13* pin forces a rebuild when the tree
# moves torch (libtorch has no ABI subslot to bind with :=). Video and
# audio format coverage follows the system ffmpeg's own USE flags; the
# image codecs are gated here.
