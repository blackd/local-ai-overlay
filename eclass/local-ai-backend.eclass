...
# preference to a FILESDIR copy. Each VAR=rel-path argument becomes an
# exported VAR="${CURDIR}/rel-path"; LD_LIBRARY_PATH is appended to
# rather than replaced, so a caller's environment survives.
