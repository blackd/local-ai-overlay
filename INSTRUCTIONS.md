...
Gitea's CI runner daemon, Go. No special steps (the go-1.26 fallback
was removed at 3.4.1). Config is generated by the built binary at
install time, not shipped.
